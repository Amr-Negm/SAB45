/****** Object:  Procedure [dbo].[UDSP_GetScenarioResponseTimeLast4Hour]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_GetScenarioResponseTimeLast4Hour]
AS
BEGIN
...
delete from [dbo].HBB_UDTB_GetScenarioResponseTime where [StoredProcedureID]=@UDSP_GetScenarioResponseTime and PeriodId=2;
...
exec [dbo].[UDSP_GetScenarioResponseTime]  @Last4Hour,@EndDate,0;
...
SELECT AlarmDefinitionTitle1 ,minval ,maxval ,avgval,@UDSP_GetScenarioResponseTime,@EndDate,2 FROM #TMPGetScenarioResponseTime;
