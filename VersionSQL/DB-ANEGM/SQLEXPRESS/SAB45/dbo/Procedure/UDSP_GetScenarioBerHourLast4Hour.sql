/****** Object:  Procedure [dbo].[UDSP_GetScenarioBerHourLast4Hour]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[UDSP_GetScenarioBerHourLast4Hour]
AS
BEGIN
...
8			LastYear
*/
delete from [dbo].HBB_UDTB_GetScenarioBerHour where [StoredProcedureID]=@UDSP_GetScenarioBerHour and PeriodId=2;
...
exec [dbo].[UDSP_GetScenarioBerHour]  @Last4Hour,@EndDate,0;
insert into [dbo].HBB_UDTB_GetScenarioBerHour(ScenarioTitle1 ,date ,total ,StoredProcedureID,ActionDate,Periodid)
SELECT ScenarioTitle1 ,date ,total ,@UDSP_GetScenarioBerHour,@EndDate,2 FROM #TMPGetScenarioBerHour;
