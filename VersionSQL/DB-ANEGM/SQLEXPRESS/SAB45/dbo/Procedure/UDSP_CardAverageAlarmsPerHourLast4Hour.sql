/****** Object:  Procedure [dbo].[UDSP_CardAverageAlarmsPerHourLast4Hour]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardAverageAlarmsPerHourLast4Hour]
AS
BEGIN
...
4	UDSP_CardAverageAlarmsPerHour
*/
EXEC	[dbo].UDSP_CardAverageAlarmsPerHour @Last4Hour,@EndDate,@SPValue1 output;
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardAverageAlarmsPerHour and PeriodId=2;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardAverageAlarmsPerHour,@SPValue1,@ActionDate,2);
end