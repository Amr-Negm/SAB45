/****** Object:  Procedure [dbo].[UDSP_Top10ChartGetTop10AlarmPerZoneLastHour]    Committed by VersionSQL https://www.versionsql.com ******/

Create PROCEDURE [dbo].[UDSP_Top10ChartGetTop10AlarmPerZoneLastHour]
...
Delete from [dbo].HBB_UDTB_Top10ChartGetTop10AlarmPerZone where [StoredProcedureID]=@UDSP_Top10ChartGetTop10AlarmPerZone and PeriodId=1;
...
exec [dbo].[UDSP_Top10ChartGetTop10AlarmPerZone_Dashboard] NULL,NULL,NULL,NULL,NULL,@LastHour,@EndDate
...
SELECT ZoneName ,No_OF_Alarm,AvgerageBerHour,Level ,ZoneID,StoredProcedureID,@EndDate,1 FROM #TMPTop10ChartGetTop10AlarmPerZone;
