/****** Object:  Procedure [dbo].[UDSP_InvestigateEvents_LessData_DelMe]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE  PROC [dbo].[UDSP_InvestigateEvents_LessData_DelMe]
...
SELECT @Sql =
CONCAT(
'SELECT * FROM InvestigatEventsTable_Temp order by ',@GroupBy,@SortBy,' ',@SortType,' OFFSET ',@PageNo,'*',@PageSize,' ROWS 
