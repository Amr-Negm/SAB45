/****** Object:  Procedure [dbo].[UDSP_CardAverageAlarmsPerWeekLastWeek]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardAverageAlarmsPerWeekLastWeek]
AS
BEGIN
...
EXEC	[UDSP_CardAverageAlarmsPerWeek]  @LastWeek,@EndDate,@SPValue1 output;
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardAverageAlarmsPerWeek and PeriodId=6;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardAverageAlarmsPerWeek,@SPValue1,@ActionDate,6);
end