/****** Object:  Procedure [dbo].[UDSP_CardHandledAlarmsLastMonth]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardHandledAlarmsLastMonth]
AS
BEGIN
...
8			LastYear
*/
EXEC	[dbo].[UDSP_CardHandledAlarms] @LastMonth,@EndDate,@SPValue1 output
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardHandledAlarms and PeriodId=7;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardHandledAlarms,@SPValue1,@ActionDate,7)
end