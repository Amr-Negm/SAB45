/****** Object:  Procedure [dbo].[UDSP_CardHandledAlarmsLastHour]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[UDSP_CardHandledAlarmsLastHour]
AS
BEGIN
...
8			LastYear
*/
EXEC	[dbo].[UDSP_CardHandledAlarms] @LastHour,@EndDate,@SPValue1 output
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardHandledAlarms and PeriodId=1;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardHandledAlarms,@SPValue1,@ActionDate,1)
end