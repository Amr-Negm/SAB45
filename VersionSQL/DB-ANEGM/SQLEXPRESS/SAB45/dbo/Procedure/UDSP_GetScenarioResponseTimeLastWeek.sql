/****** Object:  Procedure [dbo].[UDSP_GetScenarioResponseTimeLastWeek]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_GetScenarioResponseTimeLastWeek]
AS
BEGIN
...
delete from [dbo].HBB_UDTB_GetScenarioResponseTime where [StoredProcedureID]=@UDSP_GetScenarioResponseTime and PeriodId=6;
...
exec [dbo].[UDSP_GetScenarioResponseTime]  @LastWeek,@EndDate,0;
...
SELECT AlarmDefinitionTitle1 ,minval ,maxval ,avgval,@UDSP_GetScenarioResponseTime,@EndDate,6 FROM #TMPGetScenarioResponseTime;
