/****** Object:  Procedure [dbo].[UDSP_GetTopAlarmPerSource]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[UDSP_GetTopAlarmPerSource](        @City nvarchar(100)=null		,
...
-------------------------------------------------Alarms Total Number--------------------------------------------------------
	...
	if(@wherecode='')
		begin
			set @sqlstr='select top(10) count([AlarmID]) as value,TouchPointTitle1 as Name '+
