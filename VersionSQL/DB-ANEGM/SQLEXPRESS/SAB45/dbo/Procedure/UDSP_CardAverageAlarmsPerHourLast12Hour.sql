/****** Object:  Procedure [dbo].[UDSP_CardAverageAlarmsPerHourLast12Hour]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardAverageAlarmsPerHourLast12Hour]
AS
BEGIN
...
4	UDSP_CardAverageAlarmsPerHour
*/
EXEC	[dbo].UDSP_CardAverageAlarmsPerHour @Last12Hour,@EndDate,@SPValue1 output;
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardAverageAlarmsPerHour and PeriodId=3;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardAverageAlarmsPerHour,@SPValue1,@ActionDate,3);
end