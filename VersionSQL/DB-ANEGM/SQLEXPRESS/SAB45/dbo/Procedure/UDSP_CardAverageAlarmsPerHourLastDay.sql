/****** Object:  Procedure [dbo].[UDSP_CardAverageAlarmsPerHourLastDay]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardAverageAlarmsPerHourLastDay]
AS
BEGIN
...
4	UDSP_CardAverageAlarmsPerHour
*/
EXEC	[dbo].UDSP_CardAverageAlarmsPerHour @LastDay,@EndDate,@SPValue1 output;
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardAverageAlarmsPerHour and PeriodId=4;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardAverageAlarmsPerHour,@SPValue1,@ActionDate,4);
end