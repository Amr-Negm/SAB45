/****** Object:  Procedure [dbo].[UDSP_CardAverageAlarmsPerWeekLast12Hour]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardAverageAlarmsPerWeekLast12Hour]
AS
BEGIN
...
EXEC	[UDSP_CardAverageAlarmsPerWeek]  @Last12Hour,@EndDate,@SPValue1 output;
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardAverageAlarmsPerWeek and PeriodId=3;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardAverageAlarmsPerWeek,@SPValue1,@ActionDate,3);
end