/****** Object:  Procedure [dbo].[UDSP_CardAverageAlarmsPerMonthLastMonth]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardAverageAlarmsPerMonthLastMonth]
AS
BEGIN
...
EXEC	[UDSP_CardAverageAlarmsPerMonth]  @LastMonth,@EndDate,@SPValue1 output;

select @ActionDate=sysdatetime()
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardAverageAlarmsPerMonth and PeriodId=7;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardAverageAlarmsPerMonth,@SPValue1,@ActionDate,7);
end