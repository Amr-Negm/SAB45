/****** Object:  Procedure [dbo].[UDSP_FRLocationList]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE procedure  [dbo].[UDSP_FRLocationList]  (@userName nvarchar(100),@TouchPointTypeID int )
as
begin
		...
		and
		((tp.TouchPointTypeID=@TouchPointTypeID) or (LOC1.ParentLocationID is null))
