/****** Object:  Procedure [dbo].[UDSP_CardAverageAlarmsPerMonthLastYear]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardAverageAlarmsPerMonthLastYear]
AS
BEGIN
...
EXEC	[UDSP_CardAverageAlarmsPerMonth]  @LastYear,@EndDate,@SPValue1 output;

select @ActionDate=sysdatetime()
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardAverageAlarmsPerMonth and PeriodId=8;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardAverageAlarmsPerMonth,@SPValue1,@ActionDate,8);
end