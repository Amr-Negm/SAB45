/****** Object:  Procedure [dbo].[UDSP_Top10ChartGetTop10AlarmPerZoneLastYear]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_Top10ChartGetTop10AlarmPerZoneLastYear]
...
Delete from [dbo].HBB_UDTB_Top10ChartGetTop10AlarmPerZone where [StoredProcedureID]=@UDSP_Top10ChartGetTop10AlarmPerZone and PeriodId=8;
...
exec [dbo].[UDSP_Top10ChartGetTop10AlarmPerZone_Dashboard] NULL,NULL,NULL,NULL,NULL,@LastYear,@EndDate
...
SELECT ZoneName ,No_OF_Alarm,AvgerageBerHour,Level ,ZoneID,StoredProcedureID,@EndDate,8 FROM #TMPTop10ChartGetTop10AlarmPerZone;
