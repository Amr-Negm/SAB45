/****** Object:  Procedure [dbo].[UDSP_CardTotalAlarmsLastDay]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardTotalAlarmsLastDay]
AS
BEGIN
...
exec [dbo].[UDSP_CardTotalAlarms] null,null,null,null,null,@LastDay,@EndDate,@SPValue1 output 
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardTotalAlarms and PeriodId=4;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardTotalAlarms,@SPValue1,@ActionDate,4);
end