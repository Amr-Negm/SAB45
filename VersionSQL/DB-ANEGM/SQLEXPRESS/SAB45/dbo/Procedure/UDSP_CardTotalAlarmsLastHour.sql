/****** Object:  Procedure [dbo].[UDSP_CardTotalAlarmsLastHour]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[UDSP_CardTotalAlarmsLastHour]
AS
BEGIN
...
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardTotalAlarms and PeriodId=1;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardTotalAlarms,@SPValue1,@ActionDate,1);
end