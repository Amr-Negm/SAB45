/****** Object:  Procedure [dbo].[UDSP_GetAllLocations]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE procedure [dbo].[UDSP_GetAllLocations] @userName nvarchar(100)
as
begin
