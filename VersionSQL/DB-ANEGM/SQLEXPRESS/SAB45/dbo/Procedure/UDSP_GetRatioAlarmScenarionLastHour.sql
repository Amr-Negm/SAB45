/****** Object:  Procedure [dbo].[UDSP_GetRatioAlarmScenarionLastHour]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[UDSP_GetRatioAlarmScenarionLastHour]
AS
BEGIN
...
delete from [dbo].[HBB_UDTB_GetRatioAlarmScenarion] where [StoredProcedureID]=@UDSP_GetRatioAlarmScenarion and PeriodId=1;
CREATE TABLE #TMPGetRatioAlarmScenarion (Scenario nvarchar(150),Ratio nvarchar(150));
INSERT INTO #TMPGetRatioAlarmScenarion
exec [dbo].UDSP_GetRatioAlarmScenarion @LastHour,@EndDate;

insert into [dbo].[HBB_UDTB_GetRatioAlarmScenarion](Scenario ,Ratio ,StoredProcedureID,[ActionDate],PeriodId)
SELECT Scenario ,Ratio ,@UDSP_GetRatioAlarmScenarion,@EndDate,1 FROM #TMPGetRatioAlarmScenarion;
