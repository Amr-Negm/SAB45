/****** Object:  Procedure [dbo].[UDSP_GetRatioAlarmScenarionLastWeek]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_GetRatioAlarmScenarionLastWeek]
AS
BEGIN
...
delete from [dbo].[HBB_UDTB_GetRatioAlarmScenarion] where [StoredProcedureID]=@UDSP_GetRatioAlarmScenarion and PeriodId=6;
CREATE TABLE #TMPGetRatioAlarmScenarion (Scenario nvarchar(150),Ratio nvarchar(150));
INSERT INTO #TMPGetRatioAlarmScenarion
exec [dbo].UDSP_GetRatioAlarmScenarion @LastWeek,@EndDate;

insert into [dbo].[HBB_UDTB_GetRatioAlarmScenarion](Scenario ,Ratio ,StoredProcedureID,[ActionDate],PeriodId)
SELECT Scenario ,Ratio ,@UDSP_GetRatioAlarmScenarion,@EndDate,6 FROM #TMPGetRatioAlarmScenarion;
