/****** Object:  Procedure [dbo].[UDSP_GetAnalyticPerStatusLast4Hour]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_GetAnalyticPerStatusLast4Hour]
AS
BEGIN
...
delete from [dbo].HBB_UDTB_GetAnalyticPerStatus where [StoredProcedureID]=@UDSP_GetAnalyticPerStatus and PeriodId=2;
...
exec [dbo].UDSP_GetAnalyticPerStatus NULL,NULL,NULL,NULL,NULL,@Last4Hour,@EndDate;

insert into [dbo].[HBB_UDTB_GetAnalyticPerStatus](AlarmStatusTitle1 ,value ,StoredProcedureID,[ActionDate],PeriodId)
SELECT AlarmStatusTitle1 ,value ,@UDSP_GetAnalyticPerStatus,@EndDate,2 FROM #TMPGetAnalyticPerStatus;
