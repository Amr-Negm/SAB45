/****** Object:  Procedure [dbo].[UDSP_Top10ChartGetTop10AlarmPerZoneLast12Hour]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_Top10ChartGetTop10AlarmPerZoneLast12Hour]
...
Delete from [dbo].HBB_UDTB_Top10ChartGetTop10AlarmPerZone where [StoredProcedureID]=@UDSP_Top10ChartGetTop10AlarmPerZone and PeriodId=3;
...
exec [dbo].[UDSP_Top10ChartGetTop10AlarmPerZone_Dashboard] NULL,NULL,NULL,NULL,NULL,@Last12Hour,@EndDate
...
SELECT ZoneName ,No_OF_Alarm,AvgerageBerHour,Level ,ZoneID,StoredProcedureID,@EndDate,3 FROM #TMPTop10ChartGetTop10AlarmPerZone;
