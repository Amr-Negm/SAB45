/****** Object:  Procedure [dbo].[UDSP_Top10ChartGetTop10AlarmPerZoneLast2Day]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_Top10ChartGetTop10AlarmPerZoneLast2Day]
...
Delete from [dbo].HBB_UDTB_Top10ChartGetTop10AlarmPerZone where [StoredProcedureID]=@UDSP_Top10ChartGetTop10AlarmPerZone and PeriodId=5;
...
exec [dbo].[UDSP_Top10ChartGetTop10AlarmPerZone_Dashboard] NULL,NULL,NULL,NULL,NULL,@Last2Day,@EndDate
...
SELECT ZoneName ,No_OF_Alarm,AvgerageBerHour,Level ,ZoneID,StoredProcedureID,@EndDate,5 FROM #TMPTop10ChartGetTop10AlarmPerZone;
