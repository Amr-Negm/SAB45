/****** Object:  Procedure [dbo].[UDSP_CardAverageAlarmsPerDayLastHour]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[UDSP_CardAverageAlarmsPerDayLastHour]
AS
BEGIN
...
*/
EXEC	[UDSP_CardAverageAlarmsPerDay]  null,null,null,null,null,@LastHour,@EndDate,@SPValue1 output
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardAverageAlarmsPerDay and PeriodId=1;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardAverageAlarmsPerDay,@SPValue1,@ActionDate,1);
end