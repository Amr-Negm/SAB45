/****** Object:  Procedure [dbo].[UDSP_CardTotalAlarmsLastHourLastHour]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardTotalAlarmsLastHourLastHour]
AS
BEGIN
...
/*
34	UDSP_CardTotalAlarmsLastHour
*/
/*
...
exec [dbo].[UDSP_CardTotalAlarmsLastHour] @LastHour,@EndDate,@SPValue1 output 
