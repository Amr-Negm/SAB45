/****** Object:  Procedure [dbo].[UDSP_CardAverageAlarmsPerDayLastDay]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardAverageAlarmsPerDayLastDay]
AS
BEGIN
...
*/
EXEC	[UDSP_CardAverageAlarmsPerDay]  null,null,null,null,null,@LastDay,@EndDate,@SPValue1 output
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardAverageAlarmsPerDay and PeriodId=4;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardAverageAlarmsPerDay,@SPValue1,@ActionDate,4);
end