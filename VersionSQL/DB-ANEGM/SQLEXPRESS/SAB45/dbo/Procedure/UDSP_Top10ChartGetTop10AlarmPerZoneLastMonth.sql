/****** Object:  Procedure [dbo].[UDSP_Top10ChartGetTop10AlarmPerZoneLastMonth]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_Top10ChartGetTop10AlarmPerZoneLastMonth]
...
Delete from [dbo].HBB_UDTB_Top10ChartGetTop10AlarmPerZone where [StoredProcedureID]=@UDSP_Top10ChartGetTop10AlarmPerZone and PeriodId=7;
...
exec [dbo].[UDSP_Top10ChartGetTop10AlarmPerZone_Dashboard] NULL,NULL,NULL,NULL,NULL,@LastMonth,@EndDate
...
SELECT ZoneName ,No_OF_Alarm,AvgerageBerHour,Level ,ZoneID,StoredProcedureID,@EndDate,7 FROM #TMPTop10ChartGetTop10AlarmPerZone;
