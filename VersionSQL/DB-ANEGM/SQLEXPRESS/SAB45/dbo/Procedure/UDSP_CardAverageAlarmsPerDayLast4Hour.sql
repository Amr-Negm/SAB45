/****** Object:  Procedure [dbo].[UDSP_CardAverageAlarmsPerDayLast4Hour]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardAverageAlarmsPerDayLast4Hour]
AS
BEGIN
...
*/
EXEC	[UDSP_CardAverageAlarmsPerDay]  null,null,null,null,null,@Last4Hour,@EndDate,@SPValue1 output
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardAverageAlarmsPerDay and PeriodId=2;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardAverageAlarmsPerDay,@SPValue1,@ActionDate,2);
end