/****** Object:  Procedure [dbo].[UDSP_GetPropablitiyAlarmLastMonth]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[UDSP_GetPropablitiyAlarmLastMonth]
AS
BEGIN
...
delete from [dbo].[HBB_UDTB_GetPropablitiyAlarm] where [StoredProcedureID]=@UDSP_GetPropablitiyAlarm and PeriodId=7;
CREATE TABLE #TMP 
...
INSERT INTO #TMP
exec [dbo].UDSP_GetPropablitiyAlarm NULL,NULL,NULL,NULL,NULL,@LastMonth,@EndDate;
...
SELECT [ScenarioTitle1],[ScenarioImpact],[ScenarioID],[AlarmScenarioID],@UDSP_GetPropablitiyAlarm,@EndDate,7 FROM #TMP;
DROP TABLE #TMP;
end