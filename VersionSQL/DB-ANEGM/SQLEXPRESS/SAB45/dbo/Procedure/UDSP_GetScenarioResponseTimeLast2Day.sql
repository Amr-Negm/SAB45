/****** Object:  Procedure [dbo].[UDSP_GetScenarioResponseTimeLast2Day]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_GetScenarioResponseTimeLast2Day]
AS
BEGIN
...
delete from [dbo].HBB_UDTB_GetScenarioResponseTime where [StoredProcedureID]=@UDSP_GetScenarioResponseTime and PeriodId=5;
...
exec [dbo].[UDSP_GetScenarioResponseTime]  @Last2Day,@EndDate,0;
...
SELECT AlarmDefinitionTitle1 ,minval ,maxval ,avgval,@UDSP_GetScenarioResponseTime,@EndDate,5 FROM #TMPGetScenarioResponseTime;
