/****** Object:  Procedure [dbo].[UDSP_GetScenarioResponseTimeLastDay]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_GetScenarioResponseTimeLastDay]
AS
BEGIN
...
delete from [dbo].HBB_UDTB_GetScenarioResponseTime where [StoredProcedureID]=@UDSP_GetScenarioResponseTime and PeriodId=4;
...
exec [dbo].[UDSP_GetScenarioResponseTime]  @LastDay,@EndDate,0;
...
SELECT AlarmDefinitionTitle1 ,minval ,maxval ,avgval,@UDSP_GetScenarioResponseTime,@EndDate,4 FROM #TMPGetScenarioResponseTime;
