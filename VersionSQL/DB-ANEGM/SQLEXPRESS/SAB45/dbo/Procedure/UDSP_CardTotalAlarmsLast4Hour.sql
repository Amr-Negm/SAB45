/****** Object:  Procedure [dbo].[UDSP_CardTotalAlarmsLast4Hour]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardTotalAlarmsLast4Hour]
AS
BEGIN
...
exec [dbo].[UDSP_CardTotalAlarms] null,null,null,null,null,@Last4Hour,@EndDate,@SPValue1 output 
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardTotalAlarms and PeriodId=2;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardTotalAlarms,@SPValue1,@ActionDate,2);
end