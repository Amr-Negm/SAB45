/****** Object:  Procedure [dbo].[UDSP_CardHandledAlarmsLast2Day]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardHandledAlarmsLast2Day]
AS
BEGIN
...
8			LastYear
*/
EXEC	[dbo].[UDSP_CardHandledAlarms] @Last2Day,@EndDate,@SPValue1 output
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardHandledAlarms and PeriodId=5;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardHandledAlarms,@SPValue1,@ActionDate,5)
end