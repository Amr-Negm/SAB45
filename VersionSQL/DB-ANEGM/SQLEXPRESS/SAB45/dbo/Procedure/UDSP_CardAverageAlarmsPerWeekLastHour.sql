/****** Object:  Procedure [dbo].[UDSP_CardAverageAlarmsPerWeekLastHour]    Committed by VersionSQL https://www.versionsql.com ******/

Create PROCEDURE [dbo].[UDSP_CardAverageAlarmsPerWeekLastHour]
AS
BEGIN
...
EXEC	[UDSP_CardAverageAlarmsPerWeek]  @LastHour,@EndDate,@SPValue1 output;
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardAverageAlarmsPerWeek and PeriodId=1;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardAverageAlarmsPerWeek,@SPValue1,@ActionDate,1);
end