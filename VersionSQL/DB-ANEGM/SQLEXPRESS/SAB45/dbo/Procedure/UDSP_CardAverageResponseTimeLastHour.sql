/****** Object:  Procedure [dbo].[UDSP_CardAverageResponseTimeLastHour]    Committed by VersionSQL https://www.versionsql.com ******/

Create PROCEDURE [dbo].[UDSP_CardAverageResponseTimeLastHour]
AS
BEGIN
...
EXEC	[UDSP_CardAverageResponseTime]  @LastHour,@EndDate,@SPValue1 output;

delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardAverageResponseTime and PeriodId=1;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardAverageResponseTime,@SPValue1,@ActionDate,1);
