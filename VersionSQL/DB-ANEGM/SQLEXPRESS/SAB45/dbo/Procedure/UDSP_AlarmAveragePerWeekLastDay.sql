/****** Object:  Procedure [dbo].[UDSP_AlarmAveragePerWeekLastDay]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[UDSP_AlarmAveragePerWeekLastDay]
AS
BEGIN
...
delete from [dbo].HBB_UDTB_AlarmAveragePerWeek where [StoredProcedureID]=@UDSP_AlarmAveragePerWeek and PeriodId=4;
...
exec [dbo].UDSP_AlarmAveragePerWeek @LastDay,@EndDate,1;

insert into [dbo].HBB_UDTB_AlarmAveragePerWeek(AvgBerDay,Dayname,ScenarioTitle,StoredProcedureID,ActionDate,Periodid)
SELECT AvgBerDay,Dayname,ScenarioTitle,@UDSP_AlarmAveragePerWeek,@EndDate,4 FROM #TMPAlarmAveragePerWeek;
