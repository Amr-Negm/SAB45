/****** Object:  Procedure [dbo].[UDSP_CardAverageAlarmsPerDayCalled]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardAverageAlarmsPerDayCalled]
AS
BEGIN
...
@UDSP_CardAverageAlarmsPerHour int=35,
...
*/
EXEC	[UDSP_CardAverageAlarmsPerDay]  null,null,null,null,null,null,null,@SPValue1 output
...
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardAverageAlarmsPerDay and PeriodId=0;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardAverageAlarmsPerDay,@SPValue1,@ActionDate,0)
--,
