/****** Object:  Procedure [dbo].[UDSP_SelectRecentAlarms_old2]    Committed by VersionSQL https://www.versionsql.com ******/

--Requested by Kamal 6 Feb 2020
CREATE Procedure [dbo].[UDSP_SelectRecentAlarms_current] @LocationIDs nvarchar(MAX) , @AlarmCategoryIDs nvarchar(MAX), @AlarmStatusIDs nvarchar(MAX) = '(1)'
as
