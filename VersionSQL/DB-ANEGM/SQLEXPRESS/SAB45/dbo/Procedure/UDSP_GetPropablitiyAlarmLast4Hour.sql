/****** Object:  Procedure [dbo].[UDSP_GetPropablitiyAlarmLast4Hour]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[UDSP_GetPropablitiyAlarmLast4Hour]
AS
BEGIN
...
delete from [dbo].[HBB_UDTB_GetPropablitiyAlarm] where [StoredProcedureID]=@UDSP_GetPropablitiyAlarm and PeriodId=2;
CREATE TABLE #TMP 
...
INSERT INTO #TMP
exec [dbo].UDSP_GetPropablitiyAlarm NULL,NULL,NULL,NULL,NULL,@Last4Hour,@EndDate;
...
SELECT [ScenarioTitle1],[ScenarioImpact],[ScenarioID],[AlarmScenarioID],@UDSP_GetPropablitiyAlarm,@EndDate,2 FROM #TMP;
DROP TABLE #TMP;
end