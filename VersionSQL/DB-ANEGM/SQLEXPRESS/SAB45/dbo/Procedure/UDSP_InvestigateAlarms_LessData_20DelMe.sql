/****** Object:  Procedure [dbo].[UDSP_InvestigateAlarms_LessData DelMe]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE procedure  [dbo].[UDSP_InvestigateAlarms_LessData DelMe] 
...
--(EPL.STRINGVALUE '+@LocationIDs+'  OR EP.STRINGVALUE '+@TPIDs+' ) AND
...
L2.Name AS ParentLocationName,
ED.EventDefinitionTitle1 AS EventName,
S.[ScenarioTitle1],NULL,NUll,NULL
