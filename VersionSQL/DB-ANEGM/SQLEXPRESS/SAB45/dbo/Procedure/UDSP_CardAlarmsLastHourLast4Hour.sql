/****** Object:  Procedure [dbo].[UDSP_CardAlarmsLastHourLast4Hour]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardAlarmsLastHourLast4Hour]
AS
BEGIN
...
exec [dbo].[UDSP_CardAlarmsLastHour] @Last4Hour,@EndDate,@SPValue1 output 
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardAlarmsLastHour and PeriodId=2;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardAlarmsLastHour,@SPValue1,@ActionDate,2);
end