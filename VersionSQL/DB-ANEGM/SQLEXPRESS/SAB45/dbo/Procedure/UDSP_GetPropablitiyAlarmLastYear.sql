/****** Object:  Procedure [dbo].[UDSP_GetPropablitiyAlarmLastYear]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[UDSP_GetPropablitiyAlarmLastYear]
AS
BEGIN
...
delete from [dbo].[HBB_UDTB_GetPropablitiyAlarm] where [StoredProcedureID]=@UDSP_GetPropablitiyAlarm and PeriodId=8;
CREATE TABLE #TMP 
...
INSERT INTO #TMP
exec [dbo].UDSP_GetPropablitiyAlarm NULL,NULL,NULL,NULL,NULL,@LastYear,@EndDate;
...
SELECT [ScenarioTitle1],[ScenarioImpact],[ScenarioID],[AlarmScenarioID],@UDSP_GetPropablitiyAlarm,@EndDate,8 FROM #TMP;
DROP TABLE #TMP;
end