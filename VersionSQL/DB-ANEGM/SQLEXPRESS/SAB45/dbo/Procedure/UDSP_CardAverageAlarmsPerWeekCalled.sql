/****** Object:  Procedure [dbo].[UDSP_CardAverageAlarmsPerWeekCalled]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardAverageAlarmsPerWeekCalled]
AS
BEGIN
...
*/
EXEC	[UDSP_CardAverageAlarmsPerWeek]  null,null,@SPValue1 output
...
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardAverageAlarmsPerWeek and PeriodId=0;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardAverageAlarmsPerWeek,@SPValue1,@ActionDate,0)
--,
