/****** Object:  Procedure [dbo].[UDSP_CardAlarmsLastHourLastMonth]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardAlarmsLastHourLastMonth]
AS
BEGIN
...
exec [dbo].[UDSP_CardAlarmsLastHour] @LastMonth,@EndDate,@SPValue1 output 
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardAlarmsLastHour and PeriodId=7;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardAlarmsLastHour,@SPValue1,@ActionDate,7);
end