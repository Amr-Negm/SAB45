/****** Object:  Procedure [dbo].[UDSP_InvestigateEvents_LessData_DelMe2]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE  PROC [dbo].[UDSP_InvestigateEvents_LessData_DelMe2]
...
INNER JOIN	LT_AlgorithmCategories	ACat	ON ACat.AlgorithmCategoryID = A.AlgorithmCategoryID
LEFT JOIN	T_TouchPoints			TP	ON ED.TouchPointIDSource = TP.TouchPointID
INNER JOIN	LT_TouchPointTypes		TPT	ON TP.TouchPointTypeID = TPT.TouchPointTypeID
