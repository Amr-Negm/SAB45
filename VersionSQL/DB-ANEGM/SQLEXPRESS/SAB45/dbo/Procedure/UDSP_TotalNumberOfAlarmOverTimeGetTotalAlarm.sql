/****** Object:  Procedure [dbo].[UDSP_TotalNumberOfAlarmOverTimeGetTotalAlarm]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[UDSP_TotalNumberOfAlarmOverTimeGetTotalAlarm](        @City nvarchar(100)=null		,
...
-------------------------------------------------Alarms Total Number--------------------------------------------------------
	...
	if(@wherecode='')
		...
		set @sqlstr+='select AlarmID, Occurance_Date,PriorityID total from [dbo].[T_AllAlarms] Where '+@wherecode
