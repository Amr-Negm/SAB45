/****** Object:  Procedure [dbo].[UDSP_InvestigateAlarms_Count_Enhanced2]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE procedure  [dbo].[UDSP_InvestigateAlarms_Count_Enhanced2]  
...
EXECUTE (
'
SELECT COUNT(DISTINCT A.AlarmID) AS TotalCount
