/****** Object:  Procedure [dbo].[UDSP_CardAverageResponseTimeLastMonth]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardAverageResponseTimeLastMonth]
AS
BEGIN
...
EXEC	[UDSP_CardAverageResponseTime]  @LastMonth,@EndDate,@SPValue1 output;

delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardAverageResponseTime and PeriodId=7;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardAverageResponseTime,@SPValue1,@ActionDate,7);
