/****** Object:  Procedure [dbo].[UDSP_CardAverageResponseTimeCalled]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[UDSP_CardAverageResponseTimeCalled]
AS
BEGIN
...
*/
EXEC	[UDSP_CardAverageResponseTime]  null,null,@SPValue1 output
...
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardAverageResponseTime and PeriodId=0;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardAverageResponseTime,@SPValue1,@ActionDate,0)
--,
