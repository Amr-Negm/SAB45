/****** Object:  Procedure [dbo].[UDSP_CardAverageAlarmsPerHourLast2Day]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardAverageAlarmsPerHourLast2Day]
AS
BEGIN
...
4	UDSP_CardAverageAlarmsPerHour
*/
EXEC	[dbo].UDSP_CardAverageAlarmsPerHour @Last2Day,@EndDate,@SPValue1 output;
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardAverageAlarmsPerHour and PeriodId=5;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardAverageAlarmsPerHour,@SPValue1,@ActionDate,5);
end