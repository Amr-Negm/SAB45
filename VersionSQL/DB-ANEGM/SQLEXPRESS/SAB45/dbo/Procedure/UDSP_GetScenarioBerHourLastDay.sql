/****** Object:  Procedure [dbo].[UDSP_GetScenarioBerHourLastDay]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[UDSP_GetScenarioBerHourLastDay]
AS
BEGIN
...
8			LastYear
*/
delete from [dbo].HBB_UDTB_GetScenarioBerHour where [StoredProcedureID]=@UDSP_GetScenarioBerHour and PeriodId=4;
...
exec [dbo].[UDSP_GetScenarioBerHour]  @LastDay,@EndDate,0;
insert into [dbo].HBB_UDTB_GetScenarioBerHour(ScenarioTitle1 ,date ,total ,StoredProcedureID,ActionDate,Periodid)
SELECT ScenarioTitle1 ,date ,total ,@UDSP_GetScenarioBerHour,@EndDate,4 FROM #TMPGetScenarioBerHour;
