/****** Object:  Procedure [dbo].[UDSP_GetScenarioResponseTimeLastMonth]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_GetScenarioResponseTimeLastMonth]
AS
BEGIN
...
delete from [dbo].HBB_UDTB_GetScenarioResponseTime where [StoredProcedureID]=@UDSP_GetScenarioResponseTime and PeriodId=7;
...
exec [dbo].[UDSP_GetScenarioResponseTime]  @LastMonth,@EndDate,0;
...
SELECT AlarmDefinitionTitle1 ,minval ,maxval ,avgval,@UDSP_GetScenarioResponseTime,@EndDate,7 FROM #TMPGetScenarioResponseTime;
