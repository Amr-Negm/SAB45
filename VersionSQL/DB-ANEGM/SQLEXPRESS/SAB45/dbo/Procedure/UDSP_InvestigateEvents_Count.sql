/****** Object:  Procedure [dbo].[UDSP_InvestigateEvents_Count]    Committed by VersionSQL https://www.versionsql.com ******/

/****** Object:  StoredProcedure [dbo].[UDSP_InvestigateEvents_Count]    Script Date: 12/12/2021 11:38:14 AM ******/

CREATE  PROC [dbo].[UDSP_InvestigateEvents_Count]
...
execute (
'
select COUNT(DISTINCT E.eventid) AS TotalCount
