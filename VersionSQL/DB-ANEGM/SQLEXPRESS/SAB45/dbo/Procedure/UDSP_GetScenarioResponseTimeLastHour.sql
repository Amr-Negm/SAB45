/****** Object:  Procedure [dbo].[UDSP_GetScenarioResponseTimeLastHour]    Committed by VersionSQL https://www.versionsql.com ******/

Create PROCEDURE [dbo].[UDSP_GetScenarioResponseTimeLastHour]
AS
BEGIN
...
delete from [dbo].HBB_UDTB_GetScenarioResponseTime where [StoredProcedureID]=@UDSP_GetScenarioResponseTime and PeriodId=1;
...
exec [dbo].[UDSP_GetScenarioResponseTime]  @LastHour,@EndDate,0;
...
SELECT AlarmDefinitionTitle1 ,minval ,maxval ,avgval,@UDSP_GetScenarioResponseTime,@EndDate,1 FROM #TMPGetScenarioResponseTime;
