/****** Object:  Procedure [dbo].[UDSP_CardHandledAlarmsLast12Hour]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardHandledAlarmsLast12Hour]
AS
BEGIN
...
8			LastYear
*/
EXEC	[dbo].[UDSP_CardHandledAlarms] @Last12Hour,@EndDate,@SPValue1 output
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardHandledAlarms and PeriodId=3;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardHandledAlarms,@SPValue1,@ActionDate,3)
end