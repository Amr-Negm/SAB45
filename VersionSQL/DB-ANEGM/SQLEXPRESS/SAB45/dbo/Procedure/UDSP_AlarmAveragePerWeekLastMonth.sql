/****** Object:  Procedure [dbo].[UDSP_AlarmAveragePerWeekLastMonth]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[UDSP_AlarmAveragePerWeekLastMonth]
AS
BEGIN
...
delete from [dbo].HBB_UDTB_AlarmAveragePerWeek where [StoredProcedureID]=@UDSP_AlarmAveragePerWeek and PeriodId=7;
...
exec [dbo].UDSP_AlarmAveragePerWeek @LastMonth,@EndDate,1;

insert into [dbo].HBB_UDTB_AlarmAveragePerWeek(AvgBerDay,Dayname,ScenarioTitle,StoredProcedureID,ActionDate,Periodid)
SELECT AvgBerDay,Dayname,ScenarioTitle,@UDSP_AlarmAveragePerWeek,@EndDate,7 FROM #TMPAlarmAveragePerWeek;
