/****** Object:  Procedure [dbo].[UDSP_GetRatioAlarmScenarionLast2Day]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_GetRatioAlarmScenarionLast2Day]
AS
BEGIN
...
delete from [dbo].[HBB_UDTB_GetRatioAlarmScenarion] where [StoredProcedureID]=@UDSP_GetRatioAlarmScenarion and PeriodId=5;
CREATE TABLE #TMPGetRatioAlarmScenarion (Scenario nvarchar(150),Ratio nvarchar(150));
INSERT INTO #TMPGetRatioAlarmScenarion
exec [dbo].UDSP_GetRatioAlarmScenarion @Last2Day,@EndDate;

insert into [dbo].[HBB_UDTB_GetRatioAlarmScenarion](Scenario ,Ratio ,StoredProcedureID,[ActionDate],PeriodId)
SELECT Scenario ,Ratio ,@UDSP_GetRatioAlarmScenarion,@EndDate,5 FROM #TMPGetRatioAlarmScenarion;
