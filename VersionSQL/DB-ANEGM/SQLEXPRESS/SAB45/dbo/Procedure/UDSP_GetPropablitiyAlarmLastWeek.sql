/****** Object:  Procedure [dbo].[UDSP_GetPropablitiyAlarmLastWeek]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[UDSP_GetPropablitiyAlarmLastWeek]
AS
BEGIN
...
delete from [dbo].[HBB_UDTB_GetPropablitiyAlarm] where [StoredProcedureID]=@UDSP_GetPropablitiyAlarm and PeriodId=6;
CREATE TABLE #TMP 
...
INSERT INTO #TMP
exec [dbo].UDSP_GetPropablitiyAlarm NULL,NULL,NULL,NULL,NULL,@LastWeek,@EndDate;
...
SELECT [ScenarioTitle1],[ScenarioImpact],[ScenarioID],[AlarmScenarioID],@UDSP_GetPropablitiyAlarm,@EndDate,6 FROM #TMP;
DROP TABLE #TMP;
end