/****** Object:  Procedure [dbo].[UDSP_GetScenarioResponseTimeLast12Hour]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_GetScenarioResponseTimeLast12Hour]
AS
BEGIN
...
delete from [dbo].HBB_UDTB_GetScenarioResponseTime where [StoredProcedureID]=@UDSP_GetScenarioResponseTime and PeriodId=3;
...
exec [dbo].[UDSP_GetScenarioResponseTime]  @Last12Hour,@EndDate,0;
...
SELECT AlarmDefinitionTitle1 ,minval ,maxval ,avgval,@UDSP_GetScenarioResponseTime,@EndDate,3 FROM #TMPGetScenarioResponseTime;
