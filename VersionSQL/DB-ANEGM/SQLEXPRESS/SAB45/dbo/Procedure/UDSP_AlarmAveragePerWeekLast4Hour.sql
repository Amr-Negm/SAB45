/****** Object:  Procedure [dbo].[UDSP_AlarmAveragePerWeekLast4Hour]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[UDSP_AlarmAveragePerWeekLast4Hour]
AS
BEGIN
...
delete from [dbo].HBB_UDTB_AlarmAveragePerWeek where [StoredProcedureID]=@UDSP_AlarmAveragePerWeek and PeriodId=2;
...
exec [dbo].UDSP_AlarmAveragePerWeek @Last4Hour,@EndDate,1;

insert into [dbo].HBB_UDTB_AlarmAveragePerWeek(AvgBerDay,Dayname,ScenarioTitle,StoredProcedureID,ActionDate,Periodid)
SELECT AvgBerDay,Dayname,ScenarioTitle,@UDSP_AlarmAveragePerWeek,@EndDate,2 FROM #TMPAlarmAveragePerWeek;
