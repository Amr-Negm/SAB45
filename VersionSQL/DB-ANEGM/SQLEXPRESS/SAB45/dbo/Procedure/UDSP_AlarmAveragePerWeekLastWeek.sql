/****** Object:  Procedure [dbo].[UDSP_AlarmAveragePerWeekLastWeek]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[UDSP_AlarmAveragePerWeekLastWeek]
AS
BEGIN
...
delete from [dbo].HBB_UDTB_AlarmAveragePerWeek where [StoredProcedureID]=@UDSP_AlarmAveragePerWeek and PeriodId=6;
...
exec [dbo].UDSP_AlarmAveragePerWeek @LastWeek,@EndDate,1;

insert into [dbo].HBB_UDTB_AlarmAveragePerWeek(AvgBerDay,Dayname,ScenarioTitle,StoredProcedureID,ActionDate,Periodid)
SELECT AvgBerDay,Dayname,ScenarioTitle,@UDSP_AlarmAveragePerWeek,@EndDate,6 FROM #TMPAlarmAveragePerWeek;
