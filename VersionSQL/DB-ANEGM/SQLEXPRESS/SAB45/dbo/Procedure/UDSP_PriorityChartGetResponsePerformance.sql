/****** Object:  Procedure [dbo].[UDSP_PriorityChartGetResponsePerformance]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[UDSP_PriorityChartGetResponsePerformance](@City nvarchar(100)=null	,
