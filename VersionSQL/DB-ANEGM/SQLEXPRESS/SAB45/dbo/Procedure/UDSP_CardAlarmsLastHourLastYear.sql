/****** Object:  Procedure [dbo].[UDSP_CardAlarmsLastHourLastYear]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardAlarmsLastHourLastYear]
AS
BEGIN
...
exec [dbo].[UDSP_CardAlarmsLastHour] @LastYear,@EndDate,@SPValue1 output 
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardAlarmsLastHour and PeriodId=8;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardAlarmsLastHour,@SPValue1,@ActionDate,8);
end