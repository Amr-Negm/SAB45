/****** Object:  Procedure [dbo].[UDSP_CardAverageResponseTimeLastDay]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardAverageResponseTimeLastDay]
AS
BEGIN
...
EXEC	[UDSP_CardAverageResponseTime]  @LastDay,@EndDate,@SPValue1 output;

delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardAverageResponseTime and PeriodId=4;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardAverageResponseTime,@SPValue1,@ActionDate,4);
