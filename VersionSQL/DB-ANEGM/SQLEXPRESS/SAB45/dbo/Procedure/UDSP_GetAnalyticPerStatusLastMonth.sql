/****** Object:  Procedure [dbo].[UDSP_GetAnalyticPerStatusLastMonth]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_GetAnalyticPerStatusLastMonth]
AS
BEGIN
...
delete from [dbo].HBB_UDTB_GetAnalyticPerStatus where [StoredProcedureID]=@UDSP_GetAnalyticPerStatus and PeriodId=7;
...
exec [dbo].UDSP_GetAnalyticPerStatus NULL,NULL,NULL,NULL,NULL,@LastMonth,@EndDate;

insert into [dbo].[HBB_UDTB_GetAnalyticPerStatus](AlarmStatusTitle1 ,value ,StoredProcedureID,[ActionDate],PeriodId)
SELECT AlarmStatusTitle1 ,value ,@UDSP_GetAnalyticPerStatus,@EndDate,7 FROM #TMPGetAnalyticPerStatus;
