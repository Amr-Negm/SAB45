/****** Object:  Procedure [dbo].[UDSP_CardAlarmsLastHourLastDay]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[UDSP_CardAlarmsLastHourLastDay]
AS
BEGIN
...
exec [dbo].[UDSP_CardAlarmsLastHour] @LastDay,@EndDate,@SPValue1 output 
delete from [dbo].HBB_Analytics_Cards where [StoredProcedureID]=@UDSP_CardAlarmsLastHour and PeriodId=4;
insert into [dbo].HBB_Analytics_Cards([StoredProcedureID],[StoredProcedureValue],[ActionDate],PeriodId)
values 
(@UDSP_CardAlarmsLastHour,@SPValue1,@ActionDate,4);
end